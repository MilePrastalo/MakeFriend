...
class ChatAdapter(val data: List<Message>, val friendId: Long) :
    ...
    class ChatViewHolder(itemview: View, val friendId: Long) : RecyclerView.ViewHolder(itemview) {
